...
class FsInfo(object):
    ...
    :ivar uuid.UUID fsid: Filesystem UUID.
...
class BalanceArgs(object):
    ...
    :param int profiles: Match block groups having either of the given
        ...
        constants.  E.g. `BLOCK_GROUP_RAID1 | BLOCK_GROUP_DUP`
...
class FileDedupeRangeInfo(object):
    ...
    :param int fd: An open file descriptor to a destination file which should
        get content deduped.
